...
function game() {
  ...
  if (gameConfig.status === 'start') {
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press Any Arrow Keys to Start and Play and dont worry everyone is a noob in this game!!", gameConfig.screenX / 2, gameConfig.screenY / 2);
    textSize(40);
